...
> **"SpellChecker.app" would like to access files in your Downloads folder.** — Don't Allow / Allow
...
("SpellChecker.app would like to access … Downloads") is attributed to our app via TCC's
...
io.klimov.spellchecker && make run-app`, then watch `log stream --predicate 'subsystem ==
"com.apple.TCC"'`.
