...
`defaults read io.klimov.mynah` told the real story:

```
$ defaults read io.klimov.mynah
{
...
Every build of this app shares `io.klimov.mynah`, so a debug build, a `make app` release
