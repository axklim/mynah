...
- ~~**App name** — working name was the repo name `spell-checker`. It's really a "message
  polisher + English coach," so the name may change. _Decide before any user-facing UI._~~
  **Resolved (2026-08-06):** renamed to **Mynah** (CLI `mynah`, app `Mynah.app`), matching the
  public GitHub repo. See [[0009-rename-to-mynah]].
